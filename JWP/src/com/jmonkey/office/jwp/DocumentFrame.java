 ...
 */
public final class DocumentFrame extends JInternalFrame implements InternalFrameListener,
		FocusListener, VetoableChangeListener {
	...
	/**
	 * Calls activate() to make sure the editor receives focus along with the
	 * frame
	 */
