...
public abstract class OptionsPanel extends JPanel {
	...
	/**
	 * This method is called when the panel's OK button is clicked to save the
	 * new property values from the panel's text fields in the corresponding
	 ...
	 */
	protected void addPathPropertyRow(String labelText, String group, String key, int mode) {
