...
/**
 * This class provides the base class for styled document editors; e.g. for HTML
 * and RTF.
 */
public abstract class StyledEditor extends Editor implements MouseListener, KeyListener {
	...
	/**
	 * Determine if the copy of the document in the editor has changed since it
	 * was loaded, created or last saved.
	 */
	...
	/**
	 * Determine if the document contains any formatting information. If the
	 * result is false, we should be able to write it as plain text without
	 ...
	 * 
	 * @param changed
	 *            <code>true</code> marks the document as changed,
