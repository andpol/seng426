...
public final class ActionToolBar extends JToolBar {
	...
	private void addToRegistry(JButton button, PropertyChangeListener listener, Action action) {
	...
	public JButton add(boolean showText, Action action) {
		JButton button = showText ? new JButton((String) action.getValue(Action.NAME),
