...
public class OfficeHelp extends JFrame {
	 ...
	 * code is taken from the Jazilla project, but might also be in the
	 * IceBrowser Demos
	 */
	private Object iceMethodCall(String methodName, Object[] args) {
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "No such method in ice.iblite.Browser: "
					+ methodName, "Warning", JOptionPane.WARNING_MESSAGE);
		} catch (InvocationTargetException e) {
			JOptionPane.showMessageDialog(null, "InvocationTargetException in call to: "
					+ methodName, "Warning", JOptionPane.WARNING_MESSAGE);
		} catch (IllegalAccessException e) {
			JOptionPane.showMessageDialog(null, "IllegalAccessException in call to: " + methodName,
