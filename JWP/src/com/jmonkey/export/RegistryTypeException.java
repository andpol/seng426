...
public class RegistryTypeException extends RegistryPropertyException {
	...
	public RegistryTypeException(String message, String group, String key, int propertyType,
			int valueType) {
	...
	public RegistryTypeException(String message, String group, String key, int valueType) {
		super(message, group, key);
