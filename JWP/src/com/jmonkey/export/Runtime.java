...
public final class Runtime {
	...
	/**
	 * This method checks a directory to make sure it exists. If it doesn't, it
	 * is created.
	 * 
	 ...
	 * @param directory
	 *            the name of directory to ensure.
	 */
	...
	public static final Color getContrastingTextColor(Color c) {
		double brightness = (c.getRed() * 0.2125 + c.getGreen() * 0.7145 + c.getBlue() * 0.0721);
