...
public abstract class Registry {
	...
	public static final int TYPE_OBJECT_SINGLE = 3; // Object
	public static final int TYPE_OBJECT_ARRAY = 4; // Object Array
	public static final int TYPE_BOOLEAN_SINGLE = 5; // boolean
	public static final int TYPE_BYTE_SINGLE = 6; // byte
	public static final int TYPE_BYTE_ARRAY = 7; // byte Array
	public static final int TYPE_CHAR_SINGLE = 8; // char
	public static final int TYPE_CHAR_ARRAY = 9; // char Array
	public static final int TYPE_SHORT_SINGLE = 10; // short
	public static final int TYPE_INT_SINGLE = 11; // int
	public static final int TYPE_INT_ARRAY = 12; // int Array
	public static final int TYPE_LONG_SINGLE = 13; // long
	public static final int TYPE_DOUBLE_SINGLE = 14; // double
	 ...
	 * 
	 * @param version
	 *            the new registry's version numbers, or <code>null</code>.
	 ...
	 *            the name of the group
	 * @param key
	 *            the name of the key in the group
	 ...
	 *             if the property is missing.
	 */
	public abstract int[] getIntegerArray(String group, String key)
			throws RegistryPropertyException;
	 ...
	 *             if the property is missing.
	 */
	public abstract Object[] getObjectArray(String group, String key)
			throws RegistryPropertyException;
	 ...
	 *             if the property is missing.
	 */
	public abstract String[] getStringArray(String group, String key)
			throws RegistryPropertyException;
	...
	/**
	 * Returns the version numbers of the registry. Note: this is the the
	 * version number of the specific registry's implicit schema not the version
	 * number of the registry file syntax.
	 * 
	 * @return the version number as an array of ints. The number at offset 0,
	 *         is the major version number, etcetera.
	 */
	public abstract int[] getVersion();

	/**
	 * Imports a copy of the contents of a RegistryGroup object as the specified
	 * group. Does nothing if the group already exists.
	 * 
	 * @param group
	 *            the name of the group
	 * @param properties
	 *            the properties to be imported
	 */
	public abstract void importGroup(String group, RegistryGroup properties);

	/**
	 * Initialize a Registry group from an array of Strings. The array has
	 * dimensions N x 3 where N is the number of properties. Each property is
	 * defined by the three array row entries, as follows:
	 * <ul>
	 * <li><code>props[i][0]</code> gives the property name.
	 * <li><code>props[i][1]</code> gives the initial value of the property,
	 * encoded as a String. If there is no 2nd row entry, the property is
	 * defined with type "String" and an empty value.
	 * <li><code>props[i][2]</code> gives the Java type of the property. If
	 * there is no 3rd row entry, the property is assumed to have type "String".
	 * </ul>
	 * 
	 * @param group
	 *            the name of the group
	 * @param props
	 *            the property definitions are as described above.
	 * @throws RegistryException
	 *             if the property type is not supported, the value doesn't
	 *             match the type, or there is some other inconsistency.
	 */
	...
	/**
	 * Test if the registry is in sync with the stored version. Calling commit()
	 * will sync the registry with the stored version.
	 * 
	 * @return <code>true</code> if the registry is out of sync with the stored
	 *         version.
	 */
	 ...
	 *            the registry name
	 * @param encrypted
	 *            if <code>true</code> the registry name is encrypted
	 * @return boolean <code>true<code> if the Registry exists for this class, 
	 * <code>false<code> otherwise.
	 */
	 ...
	 *            the class requesting a Registry.
	 ...
	 *            the requested Registry schema version or <code>null </code>.
	 * @return the required Registry
	 * @throws IOException
	 *             if the Registry file cannot be read or created.
	 */
	...
	/**
	 * Loads a registry with the specified name. If the Registry does not yet
	 * exist, it will be created. This overload supplies a schema version for
	 * the existing / new Registry.
	 * 
	 * @param name
	 *            the name for the Registry.
	 * @param requestedVersion
	...
	/**
	 * Loads a registry with the specified name. If the Registry does not yet
	 * exist, it will be created. If a non-null version number is supplied, this
	 * will be used as the version for a new Registry; an existing Registry's
	 * version will be checked.
	 * 
	 * @param name
	 *            the name of the Registry.
	 * @param encrypted
	 *            <code>true</code> if the registry name is encrypted.
	 * @param requestedVersion
	 *            the requested Registry schema version or <code>null </code>.
	 * @return the required Registry
	 * @throws IOException
	 *             if the Registry file cannot be read or created.
	 */
	public static Registry loadForName(String name, int[] requestedVersion, boolean encrypted)
			throws IOException {
		if (encrypted) {
			name = encryptMD5(name).toUpperCase();
		}
	 ...
	 * 
	 * @param reader
	 *            the source for registry data
	 * @param requestedVersion
	 *            the requested Registry schema version or <code>null </code>.
	 * @return a Registry populated from the reader
	 * @throws IOException
	 *             if the Registry data cannot be read.
	 */
	 ...
	 * 
	 * @param registry
	 *            the source of imported registry data.
	 */
	 ...
	 * 
	 * @param reader
	 *            the source of registry data.
	 * @throws IOException
	 *             is there is a problem reading the registry data
	 */
	public abstract void read(Reader reader) throws IOException;

	/**
	 * Return the group data for the specified group. The group will maintain
	 * its reference in the registry. This is used to change the group
	 * externally from the registry. This method needs to be replaced.
	 * 
	 * @param group
	 *            the name of the group
	...
	/**
	 * Reverts the Registry to its last commited state. Registry objects created
	 * from streams, or as blanks must have their file set and be commited,
	 * before they can be reverted.
	 * 
	 * @throws IOException
	 *             if the commit fails.
	 */
